...
const CourseImage = ({ src, alt, className = "" }) => {
  ...
  if (hasError || !src) {
    return (
      <div className={`w-full h-full bg-gradient-to-br from-brand-50 to-sky-50 flex flex-col items-center justify-center text-brand-200 gap-1.5 ${className}`}>
...
const CourseCard = ({ crs, isCreatorOrAdmin, navigate }) => {
  ...
  return (
    <button
      ...
      className="group border border-slate-200 rounded-xl bg-white overflow-hidden flex flex-col justify-between hover:shadow-md hover:border-brand-100 transition-all duration-200 cursor-pointer p-3 focus-visible:ring-2 focus-visible:ring-brand focus-visible:outline-none h-full text-left"
    >
      ...
      <div className="flex flex-col md:flex-row gap-4 bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
        ...
        <div className="flex-1 relative">
          ...
          <input
            ...
            className="w-full bg-white border border-slate-200 text-slate-800 rounded-lg pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:border-brand-200 focus:ring-2 focus:ring-brand/10 placeholder:text-slate-400 transition-all"
          />
        </div>
        ...
        <div className="flex flex-wrap sm:flex-nowrap gap-3">
          <div className="flex items-center gap-2 flex-1 sm:flex-initial">
            ...
            <select
              ...
              className="bg-white border border-slate-200 text-slate-700 text-xs font-semibold rounded-lg px-3 py-2.5 focus:outline-none focus:border-brand-200 focus:ring-2 focus:ring-brand/10 transition-all cursor-pointer w-full"
