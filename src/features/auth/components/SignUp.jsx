  ...
  return (
    <>
      <div className="flex justify-center mb-2">
        <div className="w-10 h-10 bg-[#FFE700]/10 border border-[#FFE700]/30 rounded-xl flex items-center justify-center text-[#998A00]">
      ...
      <form onSubmit={handleRegister} className="space-y-3">
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-2 bg-white border border-slate-200 rounded-xl focus:border-[#998A00] focus:ring-1 focus:ring-[#998A00] font-medium text-slate-800 placeholder-slate-400 outline-none text-sm transition-all shadow-sm disabled:bg-slate-50 disabled:text-slate-400"
              required
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-[80px] py-2 bg-white border border-slate-200 rounded-xl focus:border-[#998A00] focus:ring-1 focus:ring-[#998A00] font-medium text-slate-800 placeholder-slate-400 outline-none text-sm transition-all shadow-sm disabled:bg-slate-50 disabled:text-slate-400"
              required
            ...
            {!isEmailVerified && !otpSent && (
              <button
                ...
                disabled={otpLoading}
                className="absolute inset-y-1.5 right-2 px-3 bg-[#FFE700]/15 border border-[#FFE700]/30 hover:bg-[#FFE700]/25 text-[#998A00] font-extrabold text-[10px] rounded-lg transition-all cursor-pointer flex items-center justify-center"
              >
        ...
        {!isEmailVerified && otpSent && (
          <div className="p-3 bg-[#FFE700]/5 border border-[#FFE700]/20 rounded-xl space-y-2.5 animate-fade-in">
            <div className="flex justify-between items-center">
              <span className="text-[10px] font-black text-[#998A00] tracking-wide uppercase">
                Email Verification
              </span>
              <button
                type="button"
            ...
            <div className="space-y-1.5">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2 bg-white border border-slate-200 rounded-xl focus:border-[#998A00] focus:ring-1 focus:ring-[#998A00] font-medium text-slate-800 tracking-wider placeholder-slate-400 outline-none text-xs transition-all shadow-sm"
                  required
                />
              </div>
            </div>
            ...
            <div className="flex items-center justify-between gap-2.5">
              <button
                ...
                disabled={otpLoading}
                className="flex-1 py-2 bg-[#FFE700] hover:bg-[#FFE700]/90 text-[#111111] font-extrabold rounded-xl shadow-sm text-xs transition-all cursor-pointer flex items-center justify-center"
              >
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-2 bg-white border border-slate-200 rounded-xl focus:border-[#998A00] focus:ring-1 focus:ring-[#998A00] font-medium text-slate-800 placeholder-slate-400 outline-none text-sm transition-all shadow-sm"
                  required
                  minLength="6"
                />
                <button
